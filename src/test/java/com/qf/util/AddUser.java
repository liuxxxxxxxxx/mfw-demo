...
//                userInfo.setInfo("这是一条随机生成的信息");
//                userInfo.setPhoto("assets/img/userInfophoto/"+random.nextInt(11)+".png");
                if (random.nextBoolean()){
                    userInfo.setGender(false);
                }else {
                    userInfo.setGender(true);
                }
//                u+=userInfoDao.saveuserInfo(userInfo);
            }
...
//            logger.info(e.getMessage(),e);
    ...
    public static String getChinese() {
        ...
        try { str = new String(bArr, "GB2312");
            //区位码组合成汉字
        }
        ...
        ClassPathXmlApplicationContext classPathXmlApplicationContext = new ClassPathXmlApplicationContext("spring/spring-service.xml");
